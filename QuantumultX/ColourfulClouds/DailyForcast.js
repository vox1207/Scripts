...
更新地址：https://raw.githubusercontent.com/Vaokgxi/Vox/main/QuantumultX/ColourfulClouds/DailyForcast.js
 *
功能：
√ 自动定位
√ 异常天气预警
...
[rewrite_local]
https:\/\/((weather-data\.apple)|(api.weather))\.com url script-request-header https://raw.githubusercontent.com/Vaokgxi/Vox/main/QuantumultX/ColourfulClouds/DailyForcast.js
2️⃣ 打开手机设置 > 隐私 > 定位服务
(1) 打开定位服务
...
/*
  ...
  for (let i = 0; i < 7; i++) {
    const dskycon = daily.skycon[i];
    const ddt = new Date(skycon.date);
    
    dailySkycon +=
      `${ddt.getDate()}日 ${mapSkycon(dskycon.value)[0]}` +
      (i == 6 ? "" : "\n");
